...
int main();
bool is_end_of_game(vector<int> vector1, vector<int> vector2, int a)
{
...
struct sWindow : Graph_lib::Window{
        ...
        sWindow(Point xy, int w, int h, const string& title) : Window(xy,w,h,title), test(Point(150,600), 200, 25, "Enter Initials")
    {
        ...
        void CakePosButton2_pressed(){
            ...
            if (is_end_of_game(control,myvector,56)) 
            {
                detach_swap_buttons();
                //clear_ellipses();
                attach(*buttons[10]);
        ...
        void CakePosButton4_pressed(){
            ...
            if (is_end_of_game(control,myvector,44)) 
            {
                detach_swap_buttons();
                //clear_ellipses();
                attach(*buttons[10]);
        ...
        void CakePosButton5_pressed(){
            ...
            if (is_end_of_game(control,myvector,76)) 
            {
                detach_swap_buttons();
                //clear_ellipses();
                attach(*buttons[10]);
        ...
        void CakePosButton6_pressed(){
            ...
            if (is_end_of_game(control,myvector,8)) 
            {
                detach_swap_buttons();
                //clear_ellipses();
                attach(*buttons[10]);
        ...
        void CakePosButton7_pressed(){
            ...
            if (is_end_of_game(control,myvector,7)) 
            {
                detach_swap_buttons();
                //clear_ellipses();
                attach(*buttons[10]);
        ...
        void CakePosButton8_pressed(){
            ...
            if (is_end_of_game(control,myvector,5)) 
            {
                detach_swap_buttons();
                //clear_ellipses();
                attach(*buttons[10]);
